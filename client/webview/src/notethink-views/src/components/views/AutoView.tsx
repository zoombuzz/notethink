...
export default function AutoView(props: ViewProps) {
    ...
    // aggregate (directory) mode: synthetic root has no single ng_view linetag on a top-level note, so apply a majority vote across originating files (one vote per file)
