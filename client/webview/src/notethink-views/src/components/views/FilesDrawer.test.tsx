...
// library-side test fixture: a realistic exclude glob to feed the drawer prop. intentionally not coupled to the app's DEFAULT_AGGREGATE_EXCLUDE (extension/webview own those) — this test exercises FilesDrawer rendering, not the app default
