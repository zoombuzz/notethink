...
export class NotethinkEditorProvider {
    context;
    static viewType = 'zoombuzz.notethink';
    activePanel;
    ...
    sendCommandToActiveWebview(command, payload) {
        if (!this.activePanel) {
            return;
        }
    ...
    getHtmlForWebview(webview) {
        ...
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this.context.extensionUri, clientDistDirectory, 'index.js'));
...
//# sourceMappingURL=notethinkEditor.js.map