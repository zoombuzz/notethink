...
export default function AutoView(props) {
    ...
    if (props.display_options?.focused_notes?.length) {
        const attributes = aggregateNoteLinetags(props.display_options?.focused_notes);
    ...
    return (_jsx("div", { className: view_specific_styles.fullheight, "data-auto-selected-viewtype": derived_attributes.type, children: _jsx(GenericView, { ...props, ...derived_attributes, display_options: {
                ...props.display_options,
