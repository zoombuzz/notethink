...
// regex indices support (RegExp 'd' flag); TypeScript doesn't natively type this
interface RegExpIndicesResult extends RegExpExecArray {
    indices?: {
...
export function parseLineTags(input: string, note_seq: number): HashMapOf<LineTag> | undefined {
    ...
    let matches: RegExpIndicesResult | null;
    while ((matches = regex.exec(input) as RegExpIndicesResult | null) !== null) {
